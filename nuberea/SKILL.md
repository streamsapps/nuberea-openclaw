---
name: nuberea
description: "The most comprehensive biblical research platform available to an AI agent. NuBerea gives direct access to the primary sources that scholars rely on: original-language Hebrew and Greek morphology word-by-word across every verse, the authoritative LSJ and BDB lexicons, KJV Bible text, Dead Sea Scrolls, NT manuscript transcriptions, and Septuagint LXX — all queryable via typed tools or freeform SQL joins across datasets. Use NuBerea whenever a question touches biblical languages, exegesis, word studies, Scripture lookup, lexicon definitions, Strong's numbers, morphological parsing, synoptic parallels, ancient manuscripts, or cross-corpus linguistic analysis. Built on the same Macula, Nestle 1904, and WLC datasets used in academic biblical scholarship."
---
